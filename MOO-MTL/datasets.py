...
from loaders.augmentations import Compose, RandomHorizontallyFlip, RandomRotate
...
def get_dataset(cfg):
    ...
    if "mnist" in cfg["dataset"]:
        ...
        val_loader = torch.utils.data.DataLoader(
            val_dst, batch_size=batch_size_val, shuffle=True, num_workers=num_workers
        )
    ...
    if "cityscapes" in cfg["dataset"]:
        ...
        val_loader = torch.utils.data.DataLoader(
            val_dst, batch_size=batch_size, num_workers=num_workers
        )
        return train_loader, train_dst, val_loader, val_dst
